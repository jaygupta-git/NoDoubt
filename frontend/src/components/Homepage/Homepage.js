                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-12 col-xs-12 mx-4">
                            <div className="contents">
                                <h2 className="head-title">NoDoubt <br /><small>-A Doubt Solving Platform</small></h2>
                                <p>Find the best answer to your technical question, help others answer theirs. NoDoubt is a community-based space to find and contribute answers to technical challenges.</p>
                            </div>
