...
export default function Content(props) {
    ...
    return (
        ...
        <button className='blue-button' onClick={goBack}><ArrowBackIosIcon />Go Back</button>
            {(
                () => {
                    if (state === true) {
            ...
            <div className="container" Style="height:100vh;width:70%;display:block; margin:auto;">
                ...
                <div className="d-flex flex-row">
                    <div className="d-flex flex-column col-md-0 mt-0 mx-0">
                        <button className='btn btn-white' id="queupvotebtn" onClick={(e) => upvoteQue(e, question._id)} Style="width:15px; border:none;"><ArrowUpwardIcon fontSize='small'/></button>
                        <div className='mx-3'>{queVote}</div> 
                        <button className='btn btn-white' id="quedownvotbtn" onClick={(e) => downvoteQue(e, question._id)} Style="width:15px; border:none;"><ArrowDownwardIcon fontSize='small'/></button>
                    ...
                    <div className='mt-5'>
                        {answers.map(ans => (
                            <div className="">
                                ...
                                <div className="d-flex flex-row">
                                    <div className="d-flex flex-column col-md-0 mt-0 mx-0">
                                        <button className='btn btn-white' id={"ansupvotebtn" + ans._id} onClick={(e) => upvote(e, ans._id)} Style="width:15px; border:none;"><ArrowUpwardIcon fontSize='small'/></button>
                                        <div className='mx-3'>{vote[ans._id]}</div>
                                        <button className='btn btn-white' id = {"ansdownvotebtn" + ans._id} onClick={(e) => downvote(e, ans._id)} Style="width:15px; border:none;"><ArrowDownwardIcon fontSize='small'/></button>
                                        {(
                                            () => {
