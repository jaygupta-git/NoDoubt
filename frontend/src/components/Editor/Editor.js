...
export default function Editor(props) {
    ...
    return (
        ...
        <button className='blue-button mt-5' onClick={goBack}><ArrowBackIosIcon />Go Back</button>
            ...
            <div className="container  mb-5" Style="width:70%; display:block; margin:auto; margin-top: -90px">
