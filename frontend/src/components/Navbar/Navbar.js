        ...
        <div className="container-fluid">
          <div className="navbar-brand d-flex" style={{ fontWeight: "500", color: 'black', paddingTop: "10px" }}>
            {/* <a href="/" style={iconstyle}>
              &nbsp;<i style={title}>Doubtp</i><b>Out</b>
            </a> */}
            <a href='/questions'><img src={require('./logoImage2.png')} alt='logoImage' height="70" width="120" style={{ marginTop: "-17px" }}></img></a>
          </div>
          ...
          <div className="collapse navbar-collapse" id="navbarScroll" >
            ...
            <ul className="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" Style={{ bsSscrollHheight: "100px" }}>
              <li class="nav-item">
                {localStorage.getItem("Usertype") === 'user' && (
                  <a className="nav-link mr" href="/editor" style={{ color: 'black' }}><button className='btn btn-outline-primary'>&lt;/&gt; Ask Question</button></a>
                )}
              </li>

            </ul>

            {loginStatus && (localStorage.getItem("Usertype") === 'user') && (<NavLink to='/analysis' className='btn btn-white mr-2'>Hello, {localStorage.getItem("username")}</NavLink>)}
